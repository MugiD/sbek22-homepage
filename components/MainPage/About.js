...
const About = () => {
  return (
    <Section delay={0.1}>
      ...
      <Flex justify="space-around" flexDirection={{base: "column", md: "row"}} alignItems="center">
        <Box w={{base: "100%", md: "50%"}}>
          <Paragraph>
            Bek is a full-stack developer from Kazakhstan. He works with
            different technologies such as JavaScript, C# and Python. Bek believes that
            YouTube tutorials can help him become a valuable programmer.
          </Paragraph>
        ...
        <Image src="./images/chopper.jpg" height="25%" width="25%" display={{base: "none", md: "block"}}/>
      </Flex>
    </Section>
  );
};
